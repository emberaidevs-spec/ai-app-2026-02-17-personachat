export default async function handler(req, res) {
  try {
    ...
    const systemPrompt = `You are ${persona}. Respond to the user's message in a way that is consistent with your personality and tone. Be empathetic, understanding, and provide helpful advice or insights when possible.`;
